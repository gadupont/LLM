...
# === 3. IMAGE À TRAITER ===
image_url = "https://raw.githubusercontent.com/gadupont/LLM/main/example_de_protocole/ex1/scheduleZoom.png"
...
output_path = "./llava/output2.json"
os.makedirs(os.path.dirname(output_path), exist_ok=True)
with open(output_path, "w") as f:
    f.write(full_output)

print(f"✅ Résultat sauvegardé dans : {output_path}")
print("temps pris pour l'execution" , time.time() - start)
